...
while True:
    try:
        ...
        if control_enabled:
            ...
            servo1_value = map_value(axis_left_x_1, -1, 1, 5, 60)
            servo2_value = map_value(axis_right_x_1, -1, 1, 5, 60)
            
            # Enviar los valores al Arduino
            if joystick2 is None:
                servo3_value = map_value(axis_left_x_1, -1, 1, 20, 70)
                servo4_value = map_value(axis_right_x_1, -1, 1, 5, 70)
            else:
                ...
                servo3_value = map_value(axis_left_x_2, -1, 1, 20, 70)
                servo4_value = map_value(axis_right_x_2, -1, 1, 5, 75)
